...
static lv_obj_t *tempText1;
  ...
  static lv_obj_t *labelExt, *labelBed;
#endif
...
void lv_draw_preHeat(void) {
  ...
  // Create image buttons
    ...
    if (uiCfg.para_ui_page != 1) {
      ...
      lv_big_button_create(scr, "F:/img_preheat_ABS.bin",  preheat_menu.heatABS, button_pixel_point[3].x, button_pixel_point[3].y, event_handler, ID_P_ABS);
...
void disp_temp_type() {
  if (uiCfg.curTempType == 0) {
      ...
      if (uiCfg.curSprayerChoose == 1) {
        lv_imgbtn_set_src_both(buttonType, TERN(MIXWARE_MODEL_V, "F:/img_extruct.bin", "F:/bmp_extru2.bin"));
        ...
        lv_imgbtn_set_src_both(buttonType, TERN(MIXWARE_MODEL_V, "F:/img_extruct.bin", "F:/bmp_extru1.bin"));
        if (gCfgItems.multiple_language) {
