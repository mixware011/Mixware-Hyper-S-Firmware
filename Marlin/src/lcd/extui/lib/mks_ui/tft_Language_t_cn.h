...
#define MORE_CUSTOM7_TEXT_T_CN  USER_DESC_7
  ...
  #define RUNOUT_CONF_TEXT_T_CN                   "啟動斷料檢測"
  ...
  #define FILAMENT_SENSOR_ON_T_CN                 "耗材檢測: 開"
  #define FILAMENT_SENSOR_OFF_T_CN                "耗材檢測: 關"
  #define FILAMENT_DIALOG_BREAKING_T_CN           "耗材狀態異常, 暫停打印中...."
  #define FILAMENT_DIALOG_BREAK_TITLE_T_CN        "斷料檢測: 耗材狀態異常"
