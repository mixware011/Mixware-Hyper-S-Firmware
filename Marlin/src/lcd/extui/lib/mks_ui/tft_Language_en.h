...
#define PAUSE_POSITION_EN    "Printing pause position"
...
#define WIFI_SETTINGS_TITLE_EN    "Wi-Fi Parameter"
...
#define MORE_CUSTOM7_TEXT_EN  USER_DESC_7
  ...
  #define ADJUST_Z_MENU_DEC_EN                  "Down Nozzle"
  ...
  #define EXTRUDER_2_TEXT_EN                    "Extrusion"
  #define FILAMENT_EXT0_TEXT_EN                 "Extrusion"
  #define FILAMENT_EXT1_TEXT_EN                 "Extrusion"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_EN   "Please select the filament to be loaded."
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_EN "Please select the filament to be unloaded."
  ...
  #define AUTO_LEVELING_FAILED_EN               "Auto leveling failed, click <confirm> for return!"
  #define EEPROM_SETTINGS_STORE_EN              "Store settings to printer"
  #define EEPROM_STORE_TIPS_EN                  "Store settings to printer?"
  ...
  #define PIDTEMP_SW_TITLE_EN                   "Heating Mode Setting"
  ...
  #define PIDTEMP_SW_NMODEL_TIP_EN              "   click <confirm> for change to\n        Normal Heating Mode.\n(This mode needs to be configured\n     with normal nozzle module)"
  #define PIDTEMP_SW_HMODEL_TIP_EN              "     click <confirm> for change to\n        High Temperature Mode.\n  (This mode needs to be configured\nwith high temperature nozzle module)"
  ...
  #define DEBUG_SELF_CHECK_TIPS_B_TEMP_EN       "Bed Temperature"
  #define DEBUG_SELF_CHECK_TIPS_E_HEAT_EN       "Nozzle Heat"
  #define DEBUG_SELF_CHECK_TIPS_B_HEAT_EN       "Bed Heat"
