...
#define MORE_CUSTOM7_TEXT_CN  USER_DESC_7
  ...
  #define RUNOUT_CONF_TEXT_CN                   "启动断料检测"
  #define EXTRUDER_1_TEXT_CN                    "喷头"
  #define EXTRUDER_2_TEXT_CN                    "喷头"
  #define FILAMENT_EXT0_TEXT_CN                 "喷头"
  #define FILAMENT_EXT1_TEXT_CN                 "喷头"
  ...
  #define FILAMENT_SENSOR_ON_CN                 "耗材检测: 开"
  #define FILAMENT_SENSOR_OFF_CN                "耗材检测: 关"
  #define FILAMENT_DIALOG_BREAKING_CN           "耗材状态异常, 暂停打印中...."
  #define FILAMENT_DIALOG_BREAK_TITLE_CN        "断料检测: 耗材状态异常"
